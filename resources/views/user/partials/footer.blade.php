        ...
        <div class="row py-4">
            ...
            <div class="col-lg-3 col-12 align-left">
                <a class="navbar-brand" href="index.html">
                    ...
                    <span class="text-light h5">E</span> <span class="text-light h5 semi-bold-600">Survey</span>
                </a>
                <p class="text-light my-lg-4 my-2">
                    E-survey merupakan website untuk melakukan survei terhadap kepuasan pelayanan pengadilan agama
                    banyuwangi kelas 1A
                </p>
            </div>
            ...
            <div class="row pt-2">
                <div class="col-lg-6 col-sm-12">
                    <p class="text-lg-start text-center text-light light-300">
                        © Copyright 2022 Pengadilan Agama Banyuwangi. All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
