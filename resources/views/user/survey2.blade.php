                                ...
                                <div class="card-body">
                                    <form action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="form-check mx-4">
                                                    ...
                                                    <input type='radio' name='hrkjp' class="form-check-input"
                                                        value='1' id="hrkjp1" />
                                                </div>
                                                <div class="form-check">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="form-check mx-4">
                                                    ...
                                                    <input type='radio' name='hrkp' class="form-check-input"
                                                        value='1' id="hrkp1" />
                                                </div>
                                                <div class="form-check">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input type='radio' name='kecepatan' class="form-check-input"
                                                    value='Tidak Cepat' id="kecepatan1" />
                                                <label class="form-label" for="kecepatan1">Tidak Cepat</label>
                                            </div>
                                            <div class="form-check">
                                                <input type='radio' name='kecepatan' class="form-check-input"
                                                    value='Kurang Cepat' id="kecepatan2" />
                                                <label class="form-label" for="kecepatan2">Kurang Cepat</label>
                                            </div>
                                            <div class="form-check">
                                                <input type='radio' name='kecepatan' class="form-check-input"
                                                    value='Cepat' id="kecepatan3" />
                                                <label class="form-label" for="kecepatan3">Cepat</label>
                                            </div>
                                            <div class="form-check">
                                                <input type='radio' name='kecepatan' class="form-check-input"
                                                    value='Sangat Cepat' id="kecepatan4" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="form-check mx-4">
                                                    ...
                                                    <input type='radio' name='hrkcp' class="form-check-input"
                                                        value='1' id="hrkcp1" />
                                                </div>
                                                <div class="form-check">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input type='radio' name='biaya' class="form-check-input"
                                                    value='Sangat Mahal' id="biaya1" />
                                                <label class="form-label" for="biaya1">Sangat Mahal</label>
                                            </div>
                                            <div class="form-check">
                                                <input type='radio' name='biaya' class="form-check-input"
                                                    value='Cukup Mahal' id="biaya2" />
                                                <label class="form-label" for="biaya2">Cukup Mahal</label>
                                            </div>
                                            <div class="form-check">
                                                <input type='radio' name='biaya' class="form-check-input"
                                                    value='Murah' id="biaya3" />
                                                <label class="form-label" for="biaya3">Murah</label>
                                            </div>
                                            <div class="form-check">
                                                <input type='radio' name='biaya' class="form-check-input"
                                                    value='Gratis' id="biaya4" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="form-check mx-4">
                                                    ...
                                                    <input type='radio' name='hrbiaya' class="form-check-input"
                                                        value='1' id="hrbiaya1" />
                                                </div>
                                                <div class="form-check">
                                        ...
                                        <div class="form-group mt-5 text-end">
                                            <input type="submit" class="btn btn-dark" value="Sebelumnya">
