...
@section('container')
    ...
    <div class="banner-wrapper bg-light">
        <div id="index_banner" class="banner-vertical-center-index container-fluid pt-5">
            ...
            <img src="{{ asset('admin/assets/images/logo.png') }}" alt="logo" width="150"
                style="display: block;
            margin-left: auto;
            margin-right: auto;">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-2 pb-5">
                                <h1
                                    class="banner-heading h1 text-secondary display-3 mb-0 pb-2 mx-0 px-0 light-300 typo-space-line">
